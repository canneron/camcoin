# Support for Output Descriptors in Camcoin Core

Since Camcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Camcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Camcoin Core wallets, a convenience function `combo` is
