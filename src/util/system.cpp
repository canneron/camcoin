...
const char * const BITCOIN_CONF_FILENAME = "camcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Camcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Camcoin";
#else
    // Unix
    return pathRet / ".camcoin";
#endif
#endif
}
