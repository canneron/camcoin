...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " camcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  camcoin-tx [options] <hex-tx> [commands]  Update hex-encoded camcoin transaction\n" +
            "or:     camcoin-tx [options] -create [commands]   Create hex-encoded camcoin transaction\n" +
            "\n";
