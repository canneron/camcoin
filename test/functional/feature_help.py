...
"""Verify that starting camcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start camcoin with -h for help text")
        ...
        self.log.info("Start camcoin with -version for version information")
        ...
        self.log.info("Start camcoind with -fakearg to make sure it does not start")
